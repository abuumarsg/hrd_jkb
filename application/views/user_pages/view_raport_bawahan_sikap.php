<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('kpages/raport_bawahan_sikap');?>"><i class="fas fa-calendar"></i> Daftar Agenda</a></li>
      <li><a href="<?php echo base_url('kpages/list_raport_bawahan_sikap/'.$this->uri->segment(3));?>"><i class="fa fa-users"></i> Daftar Bawahan</a></li>
...
<script src="<?php echo base_url('asset/bower_components/jquery/dist/jquery.min.js');?>"></script>
  <script type="text/javascript">
    ...
    function refreshData() {
      var datax={table:"<?php echo $this->codegenerator->encryptChar($table);?>",kode_agenda:"<?php echo $this->codegenerator->encryptChar($kode);?>",id:"<?= $this->codegenerator->encryptChar($idk);?>"}
      var callback=getAjaxData("<?php echo base_url('kagenda/report_value_bawahan_sikap/view_all/')?>",datax);
    ...
    $('#table_konversi').DataTable({
      ajax: {
        url: "<?php echo base_url('kagenda/report_value_bawahan_sikap/view_konversi')?>",
        type: 'POST',
        data:{table:"<?php echo $this->codegenerator->encryptChar($table);?>",kode_agenda:"<?php echo $this->codegenerator->encryptChar($kode);?>",id:"<?= $this->codegenerator->encryptChar($idk);?>"}
      },
      scrollX: true,
      columnDefs: [
      {   targets: 0, 
