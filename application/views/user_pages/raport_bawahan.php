    <div class="content-wrapper">
  	<section class="content-header">
  		...
  		<ol class="breadcrumb">
  			...
  			<li class="active">Agenda Akhir</li>
  		</ol>
  	</section>
  			...
  			<div class="col-md-12">
  				<div class="box box-warning">
  					<div class="box-header with-border">
  						<h3 class="box-title"><i class="fa fa-calendar"></i> Daftar Agenda Akhir</h3>
  ...
  <script type="text/javascript">
  	...
  	$(document).ready(function () {
  		$('#table_data').DataTable({
  			ajax: {
  				url: "<?php echo base_url('kagenda/raport_bawahan/view_all')?>",
  			},
  			scrollX: true,
  			columnDefs: [{
  					targets: 0,
