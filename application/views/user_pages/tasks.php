        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="callout callout-info"><label><i class="fa fa-info-circle"></i> Bantuan</label><br>Pilih Nama Agenda untuk melakukan Input Penilaian KPI Output</div>
  ...
  $(document).ready(function(){ 
    $('#table_data').DataTable( {
      ...
      {   targets: 1,
        width: '15%',
        render: function ( data, type, full, meta ) {
          return '<a href="<?php echo base_url();?>kpages/input_employee_tasks/'+full[5]+'">'+data+'<br><label class="label label-primary">'+full[6]+'</label><label class="label label-info">'+full[7]+'</label></a>';
        }
      },
      {   targets: 2,
        width: '15%',
