<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<?php if($this->uri->segment(2) == 'report_value_bawahan_group'){?>
			<li><a href="<?php echo base_url('kpages/raport_bawahan');?>"><i class="fa fa-calendar"></i> Agenda Akhir</a></li>
			<li><a href="<?php echo base_url('kpages/view_raport_bawahan/'.$this->uri->segment(3));?>"><i class="fa fa-users"></i> Daftar Bawahan</a></li>
			<?php }elseif($this->uri->segment(2) == 'report_approval_task'){?>
			<li><a href="<?php echo base_url('kpages/approval_task');?>"><i class="fa fa-check-circle"></i> Daftar Agenda</a></li>
			<li><a href="<?php echo base_url('kpages/view_approval_task/'.$this->uri->segment(3));?>"><i class="fa fa-users"></i> Daftar Karyawan</a></li>
			<?php } ?>
				...
				<div class="box box-primary">
					<div class="box-body box-profile">
						...
						<ul class="list-group list-group-unbordered"> 
							...
							<li class="list-group-item">
								<b>Periode Penilaian</b> <label class="pull-right label label-success"><?php echo (isset($kode['kode_periode']))?((!empty($kode['kode_periode']))?$this->model_master->getListPeriodePenilaianActive()[$kode['kode_periode']]:'Tahunan'):'Tahunan'; ?></label>
							</li>
							<li class="list-group-item">
						...
						<div class="row">
							<div class="col-md-12">
								<?php 
								echo form_open('kpages/print_page',['target'=>'_blank']);
									...
									<div class="tab-content">
										<div class="tab-pane active" id="tab_admin">
											<div class="">
												...
												<table id="table_data" class="table table-bordered table-striped table-responsive table_konversi" width="100%">
													<thead>
														<tr>
															<th>No.</th>
															<th>Nama</th>
												...
												<form id="form_saran">
													...
													?>
													<input type="hidden" name="periode" value="<?php echo $getData; ?>">
													<input type="hidden" name="id_karyawan" value="<?php echo $profile['id_karyawan']; ?>">
													<h3 class="box-title">Tambah Komentar & Saran</h3>
													<div class="">
														<label>Komentar</label>
														<textarea class="form-control textarea-editor" name="saran" required="required" style="border-radius: 0px;"></textarea>
													</div>
...
<script type="text/javascript">
	...
	// 	var data={id_karyawan:'<?php //echo $profile['id_karyawan']; ?>',kode:"<?php //echo $this->codegenerator->encryptChar($kode);?>",page:'fo',id_approve:'<?php //echo$id_admin?>'};
	...
	function delete_modal(id) {
		...
		loadModalAjax("<?php echo base_url('kpages/load_modal_delete')?>",'modal_delete_partial',datax,'delete');
	...
	function do_edit(){
		...
		submitAjax("<?php echo base_url('kagenda/edt_saran')?>",'edit','form_edit',null,null);
	...
	function do_add_saran() {
		submitAjax("<?php echo base_url('kagenda/add_saran')?>",null,'form_saran',null,null);
