...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		getSelect2("<?php echo base_url('kemp/data_perjalanan_dinas/employee')?>",'data_mengetahui_add,#data_menyetujui_add,#data_dibuat_add,#karyawan_add');
		getSelect2("<?php echo base_url('kemp/data_perjalanan_dinas/pilihtunjangan')?>",'data_tunjangan_add');
    	$('#karyawan_add').change(function(){
         	var kar = $('#karyawan_add').val();
			var data={kary:kar};
			var callback=getAjaxData("<?php echo base_url('kemp/data_perjalanan_dinas/cek_jumlah_karyawan')?>",data);
			var cb=getAjaxData("<?php echo base_url('kemp/data_perjalanan_dinas/diberikan_karyawan')?>",data);
			if (callback['val'] == 1) {
				$('#nominal_bbm').hide();
	...
	function view_tunjangan() {
		...
		var callback=getAjaxData("<?php echo base_url('kemp/data_perjalanan_dinas/view_tunjangan')?>",{search:data});  
	...
	function refreshData() {
		getSelect2("<?php echo base_url('kemp/data_perjalanan_dinas//nama_bagian')?>",'bagian_export');
	...
	function resetselectAdd() {
		...
		$('#data_penginapan_add').val('').trigger('change');
		getSelect2("<?php echo base_url('kemp/data_perjalanan_dinas/refreshtunjangan')?>",'data_tunjangan_add');
	...
	function tableData(kode) {
		...
		$('#table_data').DataTable( {
			ajax: {
				url: "<?php echo base_url('kemp/data_perjalanan_dinas/view_all/')?>",
				type: 'POST',
				data: datax
			},
			scrollX: true,
	...
	function refreshCode() {
		kode_generator("<?php echo base_url('kemp/data_perjalanan_dinas/kode');?>",'no_sk_add');
	}
	function view_modal(id) {
		var data={id_pd:id};
		var callback=getAjaxData("<?php echo base_url('kemp/data_perjalanan_dinas/view_one')?>",data);  
		$('#view').modal('show');
	...
	function per_trans(){
		...
		$('#table_data_trans').DataTable( {
			ajax: {
				url: "<?php echo base_url('kemp/data_perjalanan_dinas/view_all_trans/')?>",
				type: 'POST',
				data: datax
			},
			scrollX: true,
	...
	function view_modal_u(kode) {
		var data={no_sk:kode};
		var callback=getAjaxData("<?php echo base_url('kemp/data_perjalanan_dinas/view_one_trans')?>",data);
		$('#view_u').modal('show');
	...
	function edit_modal_u() {
		...
		getSelect2("<?php echo base_url('kemp/data_perjalanan_dinas/pilihtunjangan')?>",'data_tunjangan_edit');
