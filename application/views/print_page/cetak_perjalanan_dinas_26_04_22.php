			...
			<div class="col-md-8">
				...
				<table width="100%">
					<tr>
						...
						<td style="width: 5%;"></td>
						<td class="font9" style="width: 40%;"><?=$this->formatter->getDateTimeMonthFormatUser($datax['tgl_berangkat']).' sampai '.$this->formatter->getDateTimeMonthFormatUser($datax['tgl_sampai'])?></td>
					</tr>
					<tr>
					...
					<?php 
						...
						if(!empty($tunJa)){
							foreach ($tunJa as $keys => $val) {
								if($keys == 'UM'){
									echo '<th rowspan="2" class="font8" style="width: 10%;padding: 3px 3px 3px 3px;">JUMLAH TM<br>Perjalanan</th>';
								}elseif($keys == 'KAPD0002'){
									echo '<th rowspan="2" class="font8" style="width: 10%;padding: 3px 3px 3px 3px;">INSENTIF</th>';
