...
<div class="box-id">
	<div style="padding: 10px;">
		<div style="font-weight: bold;text-align: center;">TANDA TERIMA GAJI CV JATI KENCANA</div>
		...
		<table class="border" width="100%" height="5px" border="1">
			<tr style="background-color: #7C7C71;">
				<th class="center">NO</th>
				<th class="center">NIK</th>
				<th class="center">NAMA</th>
				<th class="center">JABATAN</th>
				<th class="center" colspan="2" style="width:500px">TANDA TERIMA</th>
			</tr>
			<?php
			$no = 1;
