    ...
    <head>
      ...
      <title>Data Tugas Lembur JKB</title>
      <style type="text/css">
      body {
                                      ...
                                      <td align='center' >
                                        <div class="contentEditableContainer contentTextEditable" style="border-left: 10px solid #4286f4;border-right: 10px solid #4286f4;">
                                          <div class="contentEditable" align='center'>
                                            <h3 style='color:#fff;'>Tugas Lembur Karyawan</h3>
                                          </div>
                                        </div>
                                      </td>
                                    </tr>
                     ...
                     <table width="100%"> <!-- border="0" cellspacing="0" cellpadding="0" align="left"> -->
                      ...
                      <tr>
                        <td align='left'>
                          <div class="contentEditableContainer contentTextEditable">
                            <div class="contentEditable" align='left'>
                              <p>Dengan ini bermaksud untuk memberi tugas Lembur kepada :</p>
                              <table width="100%" align='left'>  
                                ...
                                <tr>
                                  <th width="25%" align='left'>Nomor Lembur</th>
                                ...
                                <tr>
                                  <th width="25%" align='left'>Lama Lembur</th>
                                  <td> : <?php echo $lama_lembur;?></td>
                                </tr>
                                <br>
                                <tr>
