<div class="login-box-body">
    ...
    <p class="login-box-msg"><br><b>Reset Password</b></p> 
    ...
    <form id="form_reset">
      <div class="form-group has-feedback">
        <input type="hidden" id="id_short" name="id_short" value="<?=$dataShort['id']?>">
        <input type="text" name="nama" id="namaKar" class="form-control" placeholder="Nama Ksryawan" readonly="readonly" value="<?=$dataShort['nama']?>">
      </div>
      <div class="form-group has-feedback">
  ...
  function countdown(){
    ...
    var downloadTimer = setInterval(function(){
      if(timeleft <= 0){
        ...
        document.getElementById("countdown").innerHTML = "Anda akan di alihkan ke halaman Login dalam " + timeleft + " detik lagi";
      }
      timeleft -= 1;
    }, 1000);
  }
