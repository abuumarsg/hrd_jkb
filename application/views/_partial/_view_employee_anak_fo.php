...
<div id="view_anak" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-info" onclick="edit_modal_anak()"><i class="fa fa-edit"></i> Edit</button>
...
<script type="text/javascript">
  ...
  function data_anak(){
    ...
    $('#table_data_anak').DataTable( {
      ajax: {
        url: "<?php echo base_url().'kemp/emp_anak/view_all/'.$profile['nik'];'/' ?>",
        type: 'POST',
        data:{
          }
      },
  ...
  function view_modal_anak(id) {
    var data={id_anak:id};
    var callback=getAjaxData("<?php echo base_url().'kemp/emp_anak/view_one/'.$profile['nik']; ?>",data);  
  ...
  function edit_anak() {
      submitAjax("<?php echo base_url('kemp/edit_anak')?>",'edit_anak','form_edit_anak',null,null);
      $('#table_data_anak').DataTable().ajax.reload(function (){
        Pace.restart();
      });
  }
  function add_anak() {
    submitAjax("<?php echo base_url('kemp/add_anak')?>",'add_anak','form_anak_add',null,null);
