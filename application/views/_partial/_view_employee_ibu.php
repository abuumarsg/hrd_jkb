  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group clearfix">
        ...
        <div class="col-sm-9">
          <input type="text" name="no_hp_ibu" maxlength="15" class="form-control" placeholder="Nomor Telpon Ibu" value="<?php echo $profile['no_hp_ibu'];?>">
        </div>
      </div>
      <div class="form-group clearfix">
...
<script type="text/javascript">
  ...
  function add_ibu() {
    submitAjax("<?php echo base_url('employee/edit_ibu')?>",null,'form_ibu_add',null,null);
  }
</script>