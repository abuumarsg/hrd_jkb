  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group clearfix">
        ...
        <div class="col-sm-9">
        <input type="text" name="no_hp_pasangan" maxlength="15" class="form-control" placeholder="Nomor Telpon Suami/Istri" value="<?php echo $profile['no_hp_pasangan'];?>">
        </div>
      </div>
      <div class="form-group clearfix">
...
<script type="text/javascript">
  ...
  function add_pasangan() {
    submitAjax("<?php echo base_url('employee/edit_pasangan')?>",null,'form_pasangan_add',null,null);
  }
</script>