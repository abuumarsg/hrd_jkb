...
<div id="view_saudara" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-info" onclick="edit_modal_saudara()"><i class="fa fa-edit"></i> Edit</button>
...
<script type="text/javascript">
  ...
  function data_saudara(){
    ...
    $('#table_data_saudara').DataTable( {
      ajax: {
        url: "<?php echo base_url().'kemp/empsaudara/view_all/'.$profile['nik'];'/'?>",
        type: 'POST',
        data:{}
      },
      scrollX: true,
  ...
  function view_modal_saudara(id) {
    ...
    var callback=getAjaxData("<?php echo base_url().'kemp/empsaudara/view_one/'.$profile['nik']; ?>",data);  
  ...
  function edit_saudara() {
      submitAjax("<?php echo base_url('kemp/edit_saudara')?>",'edit_saudara','form_edit_saudara',null,null);
      $('#table_data_saudara').DataTable().ajax.reload(function (){
        Pace.restart();
      });
  }
  function add_saudara() {
    submitAjax("<?php echo base_url('kemp/add_saudara')?>",'add_saudara','form_saudara_add',null,null);
    $('#table_data_saudara').DataTable().ajax.reload(function (){
      Pace.restart();
    });
  }
