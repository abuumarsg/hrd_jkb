    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <?php if (in_array($access['l_ac']['edt'], $access['access'])) {
          echo '<button type="submit" class="btn btn-info" onclick="edit_modal_org()"><i class="fa fa-edit"></i> Edit</button>';
        }?>
...
<script type="text/javascript">
  ...
  function data_organisasi(){
    ...
    $('#table_data_org').DataTable( {
      ajax: {
        url: "<?php echo base_url().'employee/emp_org/view_all/'.$profile['nik']; ?>",
        type: 'POST',
  ...
  function do_add_org() {
    submitAjax("<?php echo base_url('employee/add_org')?>",'add_org','form_org_add',null,null);
  ...
  function do_edit_org() {
    submitAjax("<?php echo base_url('employee/edit_org')?>",'modal_org_edit','form_org_edit',null,null);
    $('#table_data_org').DataTable().ajax.reload(function (){
      Pace.restart();
    });
  }
