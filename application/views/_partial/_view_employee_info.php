...
<table id="view_info" class='table table-bordered table-striped table-hover'>
  <tr>
  ...
  <tr>
    <th>Agama</th>
    <td id="view_agama"><?php echo ucwords($this->otherfunctions->getReligion($profile['agama']));?></td>
  </tr>
  <tr>
...
<script type="text/javascript">
  $(document).ready(function(){
    form_property();all_property();set_interval();data_info();
  })
  function data_info(){
