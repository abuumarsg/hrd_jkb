...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="ayah">
            <?php $this->load->view('_partial/_view_employee_ayah'); ?>
        </div>
        <div class="tab-pane" id="ibu">
            <?php $this->load->view('_partial/_view_employee_ibu'); ?>
        </div>
        <div class="tab-pane" id="anak">
            <?php $this->load->view('_partial/_view_employee_anak'); ?>
        </div>
        <div class="tab-pane" id="saudara">
            <?php $this->load->view('_partial/_view_employee_saudara'); ?>
        </div>
        <div class="tab-pane" id="pasangan">
            <?php $this->load->view('_partial/_view_employee_pasangan'); ?>
        </div>
    </div>
</div>