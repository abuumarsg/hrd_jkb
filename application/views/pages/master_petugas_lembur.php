<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<small>Master Petugas Lembur</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
			<li class="active">Master Petugas Lembur</li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-list"></i> Daftar Master Petugas Lembur</h3>
...
<script type="text/javascript">
	...
	var table="master_petugas_lembur";
	var column="id_petugas_lembur";
	$(document).ready(function(){
		$('#table_data').DataTable( {
			ajax: {
				url: "<?php echo base_url('master/master_petugas_lembur/view_all/')?>",
				type: 'POST',
		...
		$('#btn_tambah').click(function(){
			...
			getSelect2("<?php echo base_url('master/master_petugas_lembur/select_employee')?>",'karyawan_add');
		})
	});
	function refreshCode() {
		kode_generator("<?php echo base_url('master/master_petugas_lembur/kode');?>",'data_kode_add');
	}
	function view_modal(id) {
		if($('#key_btn_tambah').val() == 1){
			$('#btn_tambah').click();
		}
		var data={id_petugas_lembur:id, mode: 'view'};
		var callback=getAjaxData("<?php echo base_url('master/master_petugas_lembur/view_one')?>",data);  
		$('#view').modal('show');
	...
	function edit_modal() {
		getSelect2("<?php echo base_url('master/master_petugas_lembur/select_employee')?>",'karyawan_edit');
		var id = $('input[name="data_id_view"]').val();
		var data={id_petugas_lembur:id, mode: 'edit'};
		var callback=getAjaxData("<?php echo base_url('master/master_petugas_lembur/view_one')?>",data); 
		$('#view').modal('toggle');
		setTimeout(function () {
			$('#edit').modal('show');
	...
	function do_status(id,data) {
		...
		var where={id_petugas_lembur:id};
	...
	function do_edit(){
		if($("#form_edit")[0].checkValidity()) {
			submitAjax("<?php echo base_url('master/edt_petugas_lembur')?>",'edit','form_edit',null,null);
			$('#table_data').DataTable().ajax.reload();
		}else{
			notValidParamx();
		} 
	...
	function do_add(){
		if($("#form_add")[0].checkValidity()) {
			submitAjax("<?php echo base_url('master/add_petugas_lembur')?>",null,'form_add',"<?php echo base_url('master/master_petugas_lembur/kode');?>",'data_kode_add');
