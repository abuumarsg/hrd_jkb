...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<a class="back" href="<?php echo base_url('pages/view_employee_result_kpi/'.$this->codegenerator->encryptChar($agd['kode_a_kpi']).'/'.$this->uri->segment(5));?>"><i class="fa fa-chevron-circle-left "></i></a>
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo base_url('pages/view_employee_result_kpi/'.$this->codegenerator->encryptChar($agd['kode_a_kpi']));?>"><i class="fa fa-users"></i> Daftar Karyawan</a></li>
...
<script type="text/javascript">
	...
	function getTable() {
		...
		var callback=getAjaxData("<?php echo base_url('agenda/getRaport')?>",data);
	...
	function refreshKonversi() {
 	...
 	function konversi() {
 		$('#table_konversi').DataTable({
			ajax: {
				url: "<?php echo base_url('agenda/getKonversiKpi')?>",
				type: 'POST',
			},
			order:[1,'DESC'],
			scrollX: true,
