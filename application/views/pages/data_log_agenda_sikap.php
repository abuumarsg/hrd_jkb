  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Log Agenda Aspek Sikap</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-list"></i> Daftar Log Agenda Aspek Sikap</h3>
...
<!-- view -->
  ...
  //wajib diisi
  var table="log_agenda_sikap";
  var column="id_l_a_sikap";
  $(document).ready(function(){ 
    $('#table_data').DataTable( {
      ajax: {
        url: "<?php echo base_url('agenda/log_agenda_sikap/view_all')?>",
        type: 'POST',
  ...
  function view_modal(id) {
    var data={id_l_a_sikap:id};
    var callback=getAjaxData("<?php echo base_url('agenda/log_agenda_sikap/view_one')?>",data);  
    $('#view').modal('show');
    $('.header_data').html(callback['nama']);
    $('#data_kode_view').html(callback['kode_l_a_sikap']);
    $('#data_kode_a_view').html(callback['kode_a_sikap']);
  ...
  function delete_modal(id) {
    var data={id_l_a_sikap:id};
    var callback=getAjaxData("<?php echo base_url('agenda/log_agenda_sikap/view_one')?>",data);
    var datax={table:table,column:column,id:id,nama:callback['nama'],nama_tabel:callback['nama_tabel'],del_link_tb:'agenda_sikap',del_link_col:'kode_a_sikap',del_link_data_col:callback['kode_a_sikap']};
    loadModalAjax("<?php echo base_url('pages/load_modal_delete')?>",'modal_delete_partial',datax,'delete');
  }
  //doing db transaction
  function do_status(id,data) {
    var data_table={status:data};
    var where={id_l_a_sikap:id};
  ...
  function do_edit(){
    if($("#form_edit")[0].checkValidity()) {
      submitAjax("<?php echo base_url('agenda/edt_log_agenda_sikap')?>",'edit','form_edit',null,null);
