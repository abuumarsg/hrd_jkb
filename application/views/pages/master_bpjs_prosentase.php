<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<small>Master Prosentase BPJS</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
			<li class="active">Master Prosentase BPJS</li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-list"></i> Daftar Master Prosentase BPJS</h3>
									...
									<div class="col-md-12">
										<div class="pull-left">
											<?php if (in_array($access['l_ac']['add'], $access['access'])) {
												echo '<button class="btn btn-success" id="btn_tambah" type="button" data-toggle="collapse" data-target="#add" aria-expanded="false" aria-controls="import"><i class="fa fa-plus"></i> Tambah Prosentase BPJS</button>';
											}?>
										</div>
										...
										<div class="col-md-8">
											<form id="form_add">
												<div class="form-group">
													<label>Kode Prosentase BPJS</label>
													<input type="text" placeholder="Masukkan Kode Prosentase BPJS" id="data_kode_add" name="kode" class="form-control" required="required" value="">
												</div>
												<!-- <div class="form-group">
												...
												<div class="form-group">
													<label>Nama Prosentase BPJS</label>
													<input type="text" placeholder="Masukkan Nama Prosentase BPJS" id="data_name_add" name="nama" class="form-control field" required="required">
												</div>
												<!-- <div class="form-group">
												...
												<div class="form-group">
													<label>Prosentase Perusahaan ( % )</label>
													<input type="number" placeholder="Prosentase Perusahaan" id="data_bpjs_perusahaan_add" name="prosentase_perusahaan" min="0" value="0" step="0.01" class="form-control field" required="required">
												</div>
												<div class="form-group">
													<label>Prosentase Karyawan ( % )</label>
													<input type="number" placeholder="Prosentase Karyawan" id="data_bpjs_karyawan_add" name="prosentase_karyawan" min="0" value="0" step="0.01" class="form-control field" required="required">
												</div>
												<div class="form-group">
													<label>Tahun</label>
							...
							<div class="col-md-12">
								...
								<table id="table_data" class="table table-bordered table-striped table-responsive" width="100%">
									<thead>
										<tr>
											<th>No.</th>
											<th>Kode Prosentase BPJS</th>
											<th>Nama</th>
											<th>Prosentase Perusahaan</th>
											<th>Prosentase Karyawan</th>
											<th>Tahun</th>
											<th>Tanggal</th>
											<th>Status</th> 
											<th>Aksi</th>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Kode Prosentase BPJS</label>
						...
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Prosentase Perusahaan</label>
							<div class="col-md-6" id="data_bpjs_perusahaan_view"></div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Prosentase Karyawan</label>
		...
		<div class="modal-content">
			...
			<form id="form_edit">
				<div class="modal-body">
					...
					<div class="form-group">
						<label>Kode Prosentase BPJS</label>
						<input type="text" placeholder="Masukkan Kode Periode Penggajian" id="data_kode_edit" name="kode" class="form-control" required="required" value="">
					</div>
					<div class="form-group">
						<label>Nama Prosentase BPJS</label>
...
<script type="text/javascript">
  ...
  var table="master_bpjs_prosentase";
  var column="id";
  $(document).ready(function(){
  	refreshCode();
  	$('#table_data').DataTable( {
  		ajax: {
  			url: "<?php echo base_url('master/master_bpjs_prosentase/view_all/')?>",
  			type: 'POST',
...
//   	kode_generator("<?php //echo base_url('master/master_bpjs/kode');?>",'data_kode_add');
  ...
  function view_modal(id) {
  	var data={id:id, mode: 'view'};
  	var callback=getAjaxData("<?php echo base_url('master/master_bpjs_prosentase/view_one')?>",data);  
  	$('#view').modal('show');
  	...
  	$('#data_bpjs_perusahaan_view').html(callback['prosentase_perusahaan']);
  	$('#data_bpjs_karyawan_view').html(callback['prosentase_karyawan']);
  ...
  function edit_modal() {
  	...
  	$('#data_bpjs_perusahaan_edit').val(callback['prosentase_perusahaan']);
  	$('#data_bpjs_karyawan_edit').val(callback['prosentase_karyawan']);
  ...
  function do_edit(){
  	if($("#form_edit")[0].checkValidity()) {
  		submitAjax("<?php echo base_url('master/edt_bpjs_prosentase')?>",'edit','form_edit',null,null);
  		$('#table_data').DataTable().ajax.reload();
  	}else{
  		notValidParamx();
  	} 
  ...
  function do_add(){
  	if($("#form_add")[0].checkValidity()) {
  		submitAjax("<?php echo base_url('master/add_bpjs_prosentase')?>",null,'form_add',"<?php echo base_url('master/master_bpjs/kode');?>",'data_kode_add');
