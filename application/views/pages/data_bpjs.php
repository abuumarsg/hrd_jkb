...
<script type="text/javascript">
	...
	$(document).ready(function(){
      ...
      $('#form_import').submit(function(e){
         ...
         var urladd = "<?php echo base_url(); ?>employee/import_data_bpjs";
		...
		$('#table_data').DataTable({
			ajax: {
				url: "<?php echo base_url('employee/data_bpjs/view_all/')?>",
				type: 'POST',
	...
	function refreshCode() {
		kode_generator("<?php echo base_url('employee/data_bpjs/kode');?>",'data_kode_add');
	}
	function view_modal(id) { 
		$('#view div div div.modal-body div div div div').html('');
		$('#view').modal('show')
		var data={id_k_bpjs:id, mode: 'view'};
		var callback=getAjaxData("<?php echo base_url('employee/data_bpjs/view_one')?>",data); ;
	...
	function do_edit(){
		if($("#form_edit")[0].checkValidity()) {
			submitAjax("<?php echo base_url('employee/edt_data_bpjs')?>",'edit','form_edit',null,null);
			$('#table_data').DataTable().ajax.reload();
		}else{
			notValidParamx();
		} 
	...
	function do_add(){
		if($("#form_add")[0].checkValidity()) {
			submitAjax("<?php echo base_url('employee/add_data_bpjs')?>",null,'form_add',"<?php echo base_url('employee/data_bpjs/kode');?>",'data_kode_add');
