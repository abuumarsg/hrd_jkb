  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        ...
        <small>Konversi Nilai Sikap</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li class="active">Master Konversi Nilai Sikap</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-filter"></i> Daftar Konversi Sikap</h3>
  ...
  //wajib diisi
  var table="master_konversi_sikap";
  var column="id_konversi_sikap";
  $(document).ready(function(){
    refreshCode();
    $('#table_data').DataTable( {
      ajax: {
        url: "<?php echo base_url('master/master_konversi_sikap/view_all/')?>",
        type: 'POST',
  ...
  function refreshCode() {
    kode_generator("<?php echo base_url('master/master_konversi_sikap/kode');?>",'data_kode_add');
  }
  function view_modal(id) {
    var data={id_konversi_sikap:id};
    var callback=getAjaxData("<?php echo base_url('master/master_konversi_sikap/view_one')?>",data);  
    $('#view').modal('show');
    $('.header_data').html(callback['nama']);
    $('#data_kode_view').html(callback['kode_konversi_sikap']);
  ...
  function edit_modal() {
    ...
    $('#data_kode_edit_old').val(callback['kode_konversi_sikap']);
    $('#data_kode_edit').val(callback['kode_konversi_sikap']);
  ...
  function do_status(id,data) {
    ...
    var where={id_konversi_sikap:id};
  ...
  function do_edit(){
    if($("#form_edit")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/edt_konversi_sikap')?>",'edit','form_edit',null,null);
  ...
  function do_add(){
    if($("#form_add")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/add_konversi_sikap')?>",null,'form_add',null,null);
      $('#table_data').DataTable().ajax.reload(function (){Pace.restart();},false);
      $('#form_add')[0].reset();
      refreshCode();
    }else{
