  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Penilaian Output</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li class="active">Rancangan Penilaian Output</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-list"></i> Daftar Rancangan Penilaian Output</h3>
            ...
            <div class="box-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="pull-left">
                        ...
                        <a href="<?php echo base_url('setting/generate_new_concept');?>" class="btn btn-danger btn-flat"><i class="fa fa-qrcode"></i> Generate Nama Otomatis</a><?php } ?>
                      </div>
                    ...
                    <div class="collapse" id="add">
                      ...
                      <div class="col-md-8">
                        <?php echo form_open('setting/add_concept');?>
                        <p class="text-danger">Semua data harus diisi!</p>
                        <div class="form-group">
                          <label>Nama Rancangan Output</label>
                          <input type="text" placeholder="Masukkan Nama Rancangan Output" name="nama" class="form-control" required="required">
                        </div>
                        <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  ?>
                  <div class="callout callout-info"><label><i class="fa fa-info-circle"></i> Bantuan</label><br>Pilih Nama Rancangan Output untuk melakukan setting Rancangan Penilaian Output</div>
                    ...
                    <tbody>
                      <?php
                        ...
                        foreach ($set as $l) {
                          echo '<tr>
                                  <td width="3%">'.$n.'.</td>
                                  <td><a href="'.base_url('pages/view_concept/'.$l->kode_c_kpi).'">'.$l->nama.'</a></td>
                                  ...
                                  if ($l->nama_tabel != NULL || $l->nama_tabel != '') {
                                    $dd=$this->db->get($l->nama_tabel)->result();
                                    if (count($dd) == 0) {
                                  ...
                                  if ($l->status == "aktif") {
                                    echo form_open('setting/status_concept').'
                                    <input type="hidden" name="id" value="'.$l->id_c_kpi.'">
