  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        ...
        <small>Konversi Nilai GAP</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li class="active">Master Konversi Nilai GAP</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-filter"></i> Daftar Konversi GAP</h3>
                      ...
                      <div class="col-md-8">
                        <form id="form_add">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0" placeholder="Masukkan Batas Bawah" id="data_batas_bawah_add" name="min" class="form-control" required="required">
                          </div>
                          <div class="form-group">
                            <label>Batas Atas</label>
                            <input type="number" step="0.01" min="0" placeholder="Masukkan Batas Atas" id="data_batas_atas_add" name="max" class="form-control" required="required">
                          </div>
                          <div class="form-group">
                            <label>Huruf</label>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="form_edit">
                ...
                <div class="form-group">
                  <label>Batas Bawah</label>
                  <input type="number" step="0.01" min="0" placeholder="Masukkan Batas Bawah" id="data_batas_bawah_edit" name="min" class="form-control" required="required">
                </div>
                <div class="form-group">
                  <label>Batas Atas</label>
                  <input type="number" step="0.01" min="0" placeholder="Masukkan Batas Atas" id="data_batas_atas_edit" name="max" class="form-control" required="required">
                </div>
                <div class="form-group">
                  <label>Huruf</label>
  ...
  //wajib diisi
  var table="master_konversi_gap";
  var column="id_konversi_gap";
  $(document).ready(function(){
    refreshCode();
    $('#table_data').DataTable( {
      ajax: {
        url: "<?php echo base_url('master/master_konversi_gap/view_all/')?>",
        type: 'POST',
  ...
  function refreshCode() {
    kode_generator("<?php echo base_url('master/master_konversi_gap/kode');?>",'data_kode_add');
  }
  function view_modal(id) {
    var data={id_konversi_gap:id};
    var callback=getAjaxData("<?php echo base_url('master/master_konversi_gap/view_one')?>",data);  
    $('#view').modal('show');
    $('.header_data').html(callback['nama']);
    $('#data_kode_view').html(callback['kode_konversi_gap']);
  ...
  function edit_modal() {
    ...
    $('#data_kode_edit_old').val(callback['kode_konversi_gap']);
    $('#data_kode_edit').val(callback['kode_konversi_gap']);
  ...
  function do_edit(){
    if($("#form_edit")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/edt_konversi_gap')?>",'edit','form_edit',null,null);
  ...
  function do_add(){
    if($("#form_add")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/add_konversi_gap')?>",null,'form_add',null,null);
      $('#table_data').DataTable().ajax.reload(function (){Pace.restart();},false);
      $('#form_add')[0].reset();
      refreshCode();
    }else{
