<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<small>Master Petugas PPH</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
			<li class="active">Master Petugas PPH</li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-list"></i> Daftar Master Petugas PPH</h3>
									...
									<div class="collapse" id="add">
										...
										<div class="col-md-8">
											<form id="form_add">
												...
												<div class="form-group">
													<label>Jabatan Petugas PPH</label>
												...
												<!-- <div class="form-group">
													...
													?>
													<label>Jabatan Peserta PPH</label>
...
<script type="text/javascript">
	...
	var table="master_petugas_pph";
	var column="id_petugas_pph";
	$(document).ready(function(){
		$('#table_data').DataTable( {
			ajax: {
				url: "<?php echo base_url('master/master_petugas_pph/view_all/')?>",
				type: 'POST',
		...
		$('#btn_tambah').click(function(){
			...
			getSelect2("<?php echo base_url('master/master_petugas_pph/select_employee')?>",'karyawan_add');
		})
	});
	function refreshCode() {
		kode_generator("<?php echo base_url('master/master_petugas_pph/kode');?>",'data_kode_add');
	}
	function view_modal(id) {
		if($('#key_btn_tambah').val() == 1){
			$('#btn_tambah').click();
		}
		var data={id_petugas_pph:id, mode: 'view'};
		var callback=getAjaxData("<?php echo base_url('master/master_petugas_pph/view_one')?>",data);  
		$('#view').modal('show');
	...
	function edit_modal() {
			getSelect2("<?php echo base_url('master/master_petugas_pph/select_employee')?>",'karyawan_edit');
		var id = $('input[name="data_id_view"]').val();
		var data={id_petugas_pph:id, mode: 'edit'};
		var callback=getAjaxData("<?php echo base_url('master/master_petugas_pph/view_one')?>",data); 
		$('#view').modal('toggle');
		setTimeout(function () {
			$('#edit').modal('show');
	...
	function do_edit(){
		if($("#form_edit")[0].checkValidity()) {
			submitAjax("<?php echo base_url('master/edt_petugas_pph')?>",'edit','form_edit',null,null);
			$('#table_data').DataTable().ajax.reload();
		}else{
			notValidParamx();
		}
	...
	function do_add(){
		if($("#form_add")[0].checkValidity()) {
			submitAjax("<?php echo base_url('master/add_petugas_pph')?>",null,'form_add',"<?php echo base_url('master/master_pph/kode');?>",'data_kode_add');
