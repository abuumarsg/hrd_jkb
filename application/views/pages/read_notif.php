<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('pages/read_all_notification');?>"><i class="fa fa-bell-o"></i> Semua Notifikasi</a></li>
                      ...
                      <div class="modal-dialog modal-sm modal-danger">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo form_open('master/del_notif_users');?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <?php
                      ...
                      <small>Salam, <br><br><cite title="Source Title"><?php echo $notif['create_by'];?></cite></small>
                    </div>
                  </div>
                </div>
              </div>
