  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-money"></i> Data Denda 
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li class="active">Daftar Data Denda</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-warning"></i> Daftar Data Denda</h3>
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <?php 
                  if (count($denda) == 0) {
                    echo '<div class="callout callout-danger"><label><i class="fa fa-info-circle"></i> Data Kosong</label><br>Tidak ada data yang ditampilkan, Data Denda Hanya dapat dibuat jika anda membuat Agenda Baru pada menu <a href="'.base_url('pages/agenda').'">Agenda Penilaian > Daftar Agenda</a></div>';
                  }else{
                  ?>
                  <div class="callout callout-info"><label><i class="fa fa-info-circle"></i> Bantuan</label><br>Pilih Nama Data untuk melakukan Input atau Edit Data Denda</div>
                    ...
                    <tbody>
                      <?php
                        ...
                        foreach ($denda as $l) {
                          echo '<tr>
                                  <td width="3%">'.$n.'.</td>
                                  <td width="15%"><a href="'.base_url('pages/view_denda/'.$l->kode_denda).'">'.$l->nama_denda.'</a> ';
                                  if ($l->edit == 0) {
                                  ...
                                  if ($l->kode_agenda == NULL) {
                                    echo '<label class="label label-danger">Data Denda Tidak Berkaitan Dengan Agenda</label>';
                                  }else{
                                    $dta=$this->db->get_where('log_agenda',array('kode_agenda'=>$l->kode_agenda))->row_array();
                                    if ($dta == "") {
                                      echo '<label class="label label-danger">Data Denda Tidak Berkaitan Dengan Agenda</label><br>';
                                    }else{
                                      echo '<p><i class="fa fa-check-circle text-success"></i> Data Denda Terkait dengan '.$dta['nama_agenda'].' Semester '.$dta['semester'].'</p>';
                                    }
                                  }
                                  echo '</td>
                                  ...
                                  $tb=$l->nama_tabel;
                                  $dat=$this->db->get_where($tb,array('id_denda'=>'1'))->row_array();
                                  if ($dat['ratapyd'] == 0) {
                                  ...
                                  <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body text-center">';
                                        if ($l->edit == 0) {
                                          echo '<p>Apakah anda yakin akan membuka kunci data dengan nama <b>'.$l->nama_denda.'</b> agar bisa diupdate?</p>';
                                        }else{
                                          echo '<p>Apakah anda yakin akan mengunci data dengan nama <b>'.$l->nama_denda.'</b> agar TIDAK bisa diupdate?</p>';
                                        }
                                        
                                      echo '</div>
                                      <div class="modal-footer">
                                      '.form_open('denda/lock_denda').'
                                        <input type="hidden" name="id" value="'.$l->id_denda.'">';
                                        if ($l->edit == 0) {
                                ...
                                if (in_array($access['l_ac']['del'], $access['access'])) {
                                  ...
                                  <div class="modal-dialog modal-sm modal-danger">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body text-center">
                                        <p>Apakah anda yakin akan menghapus data denda dengan nama <b>'.$l->nama_denda.'</b> dan seluruh data penilaian pada denda tersebut?</p>
                                      </div>
                                      <div class="modal-footer">
                                      '.form_open('denda/del_denda').'
                                        <input type="hidden" name="id" value="'.$l->id_denda.'">
