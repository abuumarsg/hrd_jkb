<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<small>View Detail Periode</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
			<li><a href="<?php echo base_url('pages/periode_penggajian');?>"><i class="fa far fa-credit-card"></i> Data Periode</a></li>
			<li class="active">View Detail Periode</li>
		</ol>
	</section>
										...
										<div class="col-md-8">
											<form id="form_add">
												...
												<!-- <div class="form-group">
													...
													<select class="form-control select2" id="departemen_add" name="level" style="width: 100%;"></select>
												</div> -->
												<div class="form-group">
...
<script type="text/javascript">
	...
	/*wajib diisi*/
	var table="data_periode_penggajian_detail";
	var column="id_periode_detail";
	$(document).ready(function(){ 
		$('#table_data_detail').DataTable();
		$('#table_data').DataTable( {
			ajax: {
				url: "<?php echo base_url('master/view_periode_penggajian/view_all/'.$this->uri->segment(3))?>",
				type: 'POST',
		...
		$('#btn_tambah').click(function(){
			...
			getSelect2("<?php echo base_url('master/view_periode_penggajian/selectLevel')?>",'departemen_add');
		});
      	// select_data('departemen_add',url_select,'master_level_struktur','kode_level_struktur','nama','placeholder');
		// unsetoption('departemen_add',['STR001']);
	});
	function refreshCode() {
		kode_generator("<?php echo base_url('master/view_periode_penggajian/kode');?>",'data_kode_add');
	}
	function get_child(usage,value) {
		var data={kode_loker:value};
		var callback=getAjaxData("<?php echo base_url('master/view_periode_penggajian/child')?>",data);
	...
	function view_modal(id) {
		...
		var callback=getAjaxData("<?php echo base_url('master/view_periode_penggajian/view_one')?>",data);  
		$('#view').modal('show');
	...
	function do_edit(){
		if($("#form_edit")[0].checkValidity()) {
			submitAjax("<?php echo base_url('master/edt_periode_detail')?>",'edit','form_edit',null,null);
			$('#table_data').DataTable().ajax.reload();
		}else{
			notValidParamx();
		} 
	...
	function do_add(){
		if($("#form_add")[0].checkValidity()) {
			submitAjax("<?php echo base_url('master/add_periode_detail')?>",null,'form_add',null,null);
