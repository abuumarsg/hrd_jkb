...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<i class="fa fas fa-calendar-plus fa-fw"></i> Rencana Lembur
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo base_url('pages/data_lembur');?>"><i class="fa fas fa-calendar-plus fa-fw"></i> Data Rencana Lembur</a></li>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="pull-left" style="font-size: 8pt;">
									<?php 
									echo form_open('rekap/export_data_lembur_plan');
				...
				<form id="form_edit">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">Nomor Rencana Lembur</label>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#table_data').DataTable( {
			ajax: {
				url: "<?php echo base_url('presensi/view_lembur_plan/view_all/'.$this->uri->segment(3))?>",
				type: 'POST',
		...
		$('#btn_tambah').click(function(){
			getSelect2("<?php echo base_url('employee/mutasi_jabatan/employee')?>",'id_dibuat_add,#id_diperiksa_add,#id_diketahui_add');
		})
	...
	function refreshCode() {
		kode_generator("<?php echo base_url('presensi/data_lembur_plan/kode');?>",'kode_spl_add');
	}
	...
	function view_modal(id) {
		...
		var callback=getAjaxData("<?php echo base_url('presensi/view_lembur_plan/view_one')?>",data);  
		$('#view').modal('show');
	...
	function edit_modal() {
		getSelect2("<?php echo base_url('employee/mutasi_jabatan/employee')?>",'id_dibuat_edit,#id_diperiksa_edit,#id_diketahui_edit');
...
// addValueEditor('keterangan_edit',callback['e_keterangan']);
	...
	function do_edit(){
		if($("#form_edit")[0].checkValidity()) {
			submitAjax("<?php echo base_url('presensi/edit_lembur_plan')?>",'edit','form_edit',null,null);
			$('#table_data').DataTable().ajax.reload();
		}else{
			notValidParamx();
		} 
	...
	function do_add(){
		if($("#form_add")[0].checkValidity()) {
			submitAjax("<?php echo base_url('presensi/add_lembur_plan')?>",null,'form_add',null,null);
