  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        ...
        <small>Konversi Nilai Tahunan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li class="active">Master Konversi Nilai Tahunan</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-filter"></i> Daftar Konversi Tahunan</h3>
  ...
  //wajib diisi
  var table="master_konversi_tahunan";
  var column="id_konversi_tahunan";
  $(document).ready(function(){
    refreshCode();
    $('#table_data').DataTable( {
      ajax: {
        url: "<?php echo base_url('master/master_konversi_tahunan/view_all/')?>",
        type: 'POST',
  ...
  function refreshCode() {
    kode_generator("<?php echo base_url('master/master_konversi_tahunan/kode');?>",'data_kode_add');
  }
  function view_modal(id) {
    var data={id_konversi_tahunan:id};
    var callback=getAjaxData("<?php echo base_url('master/master_konversi_tahunan/view_one')?>",data);  
    $('#view').modal('show');
    $('.header_data').html(callback['nama']);
    $('#data_kode_view').html(callback['kode_konversi_tahunan']);
  ...
  function edit_modal() {
    ...
    $('#data_kode_edit_old').val(callback['kode_konversi_tahunan']);
    $('#data_kode_edit').val(callback['kode_konversi_tahunan']);
  ...
  function do_status(id,data) {
    ...
    var where={id_konversi_tahunan:id};
  ...
  function do_edit(){
    if($("#form_edit")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/edt_konversi_tahunan')?>",'edit','form_edit',null,null);
  ...
  function do_add(){
    if($("#form_add")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/add_konversi_tahunan')?>",null,'form_add',null,null);
      $('#table_data').DataTable().ajax.reload(function (){Pace.restart();},false);
      $('#form_add')[0].reset();
      refreshCode();
    }else{
