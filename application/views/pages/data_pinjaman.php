										...
										<div class="col-md-8">
											<form id="form_add">
												...
												<div class="form-group">
													...
													<input type="text" placeholder="Angsuran Ke" id="data_angsuran_ke_add" name="angsuran_ke" min="0" value="0" class="form-control field input-number" required="required">
												</div>
												<div class="form-group">
		...
		<div class="modal-content">
			...
			<form id="form_edit">
				<div class="modal-body">
					...
					<div class="form-group">
						<label>Pilih Karyawan</label>
						<select class="form-control select2" name="karyawan" id="data_karyawan_edit" style="width: 100%;"></select>
					</div>
					<div class="form-group">
						<label>Nominal</label>
