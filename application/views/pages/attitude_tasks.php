  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <i class="fa fa-tasks"></i> Daftar Penilaian Sikap (360°) 
        <small>Input Nilai</small> 
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li class="active">Daftar Agenda Penilaian Sikap (360°)</li>
      </ol>
    </section>
                    ...
                    <tbody>
                      <?php
                        ...
                        foreach ($attd as $l) { 
                          echo '<tr>
                                  <td width="3%">'.$n.'.</td>
                                  <td width="15%"><a href="'.base_url('pages/input_attitude_tasks_value/'.$l->kode_agenda).'">'.$l->nama_agenda.' <br>
                                  ...
                                  if ($l->keterangan == "not_entry") {
                                    ...
                                    $dto=$this->db->query("SELECT * FROM $nmtb1 WHERE nilai_akhir != 0")->num_rows();
                                    $dtt1=$this->db->get($nmtb1)->num_rows();
                                    $tdto=$dto;
                                    $jm1= ($tdto/($dtt1))*100;
