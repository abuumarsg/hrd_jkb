<div class="content-wrapper">
   <section class="content-header">
      <h1>
         ...
         <small>Master Induk Grade</small>
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
         <li class="active">Master Induk Grade</li>
      </ol>
   </section>
         ...
         <div class="col-md-12">
            <div class="box box-success">
               <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-list"></i> Daftar Induk Grade</h3>
               ...
               <div class="box-body">
                                 ...
                                 <div class="col-md-12">
                                    <div class="pull-left">
                                       <?php if (in_array($access['l_ac']['add'], $access['access'])) {
                                          echo '<a href="#add" data-toggle="collapse"  data-parent="#accordion" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Induk Grade</a>
                                          <a href="#add_master" data-toggle="collapse" data-parent="#accordion" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Master Grade</a>';
                                       }?>
                                      <div class="btn-group">
                                 ...
                                 <div class="collapse" id="add">
                                    ...
                                    <div class="col-md-8">
                                       <form id="form_add">
                                          ...
                                          <div class="form-group">
                                             <label>Nama Induk Grade</label>
                                             <input type="text" placeholder="Masukkan Nama Induk Grade" id="data_name_add" name="nama" class="form-control field" required="required">
                                          </div>
                                          <div class="form-group">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="callout callout-info"><label><i class="fa fa-info-circle"></i> Bantuan</label><br>Pilih <b>Kode Induk Grade</b> untuk melihat turunan dari <b>Induk Grade</b> dan juga untuk menambahkan grade dari <b>Induk Grade</b> tersebut</div>
                        <table id="table_data" class="table table-bordered table-striped table-responsive" width="100%">
                           <thead>
                              <tr>
                                 <th>No.</th>
                                 <th>Kode Induk Grade</th>
                                 <th>Nama Induk Grade</th>
                                 <th>Jumlah Turunan Grade</th>
                                 <th>Tanggal</th>
                                 <th>Status</th> 
                                 <th>Aksi</th>
                              </tr>
...
<script type="text/javascript">
  var url_select="<?php echo base_url('global_control/select2_global');?>";
   var table="master_induk_grade";
   var column="id_induk_grade";
   $(document).ready(function(){
      refreshCode();
      $('#table_data').DataTable( {
         ajax: {
            url: "<?php echo base_url('master/master_induk_grade/view_all/')?>",
            type: 'POST',
         ...
         {   targets: 1,
            width: '15%',
            render: function ( data, type, full, meta ) {
               return '<a href="<?php base_url()?>master_grade/'+full[7]+'">'+data+'</a>';
            }
         },
         {   targets: 5,
            width: '10%',
   ...
   function refreshCode() {
      kode_generator("<?php echo base_url('master/master_induk_grade/kode');?>",'data_kode_add');
      kode_generator("<?php echo base_url('master/master_grade/kode');?>",'data_kode_master_add');
   ...
   function view_modal(id) {
      var data={id_induk_grade:id};
      var callback=getAjaxData("<?php echo base_url('master/master_induk_grade/view_one')?>",data);  
      $('#view').modal('show');
      $('.header_data').html(callback['nama']);
      $('#data_kode_view').html(callback['kode_induk_grade']);
   ...
   function edit_modal() {
      ...
      $('#data_kode_edit_old').val(callback['kode_induk_grade']);
      $('#data_kode_edit').val(callback['kode_induk_grade']);
   ...
   function do_edit(){
      if($("#form_edit")[0].checkValidity()) {
         submitAjax("<?php echo base_url('master/edt_induk_grade')?>",'edit','form_edit',null,null);
         $('#table_data').DataTable().ajax.reload();
      }else{
         notValidParamx();
      } 
   ...
   function do_add(){
      if($("#form_add")[0].checkValidity()) {
         submitAjax("<?php echo base_url('master/add_induk_grade')?>",null,'form_add',null,null);
         $('#table_data').DataTable().ajax.reload(function (){
            Pace.restart();
         });
         $('#form_add')[0].reset();
