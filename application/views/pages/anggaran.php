  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-balance-scale"></i> Data Anggaran 
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li class="active">Daftar Data Anggaran</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-balance-scale"></i> Daftar Data Anggaran</h3>
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <?php 
                  if (count($anggaran) == 0) {
                    echo '<div class="callout callout-danger"><label><i class="fa fa-info-circle"></i> Data Kosong</label><br>Tidak ada data yang ditampilkan, Data Anggaran Hanya dapat dibuat jika anda membuat Agenda Baru pada menu <a href="'.base_url('pages/agenda').'">Agenda Penilaian > Daftar Agenda</a></div>';
                  }else{
                  ?>
                  <div class="callout callout-info"><label><i class="fa fa-info-circle"></i> Bantuan</label><br>Pilih Nama Data untuk melakukan Input atau Edit Data Perbandingan Anggaran</div>
                    ...
                    <tbody>
                      <?php
                        ...
                        foreach ($anggaran as $l) {
                          echo '<tr>
                                  <td width="3%">'.$n.'.</td>
                                  <td width="15%"><a href="'.base_url('pages/view_anggaran/'.$l->kode_anggaran).'">'.$l->nama_anggaran.'</a> ';
                                  if ($l->edit == 0) {
                                  ...
                                  if ($l->kode_agenda == NULL) {
                                    echo '<label class="label label-danger">Data Perbandingan Anggaran Tidak Berkaitan Dengan Agenda</label>';
                                  }else{
                                    $dta=$this->db->get_where('log_agenda',array('kode_agenda'=>$l->kode_agenda))->row_array();
                                    if ($dta == "") {
                                      echo '<label class="label label-danger">Data Perbandingan Anggaran Tidak Berkaitan Dengan Agenda</label><br>';
                                    }else{
                                      echo '<p><i class="fa fa-check-circle text-success"></i> Data Perbandingan Anggaran Terkait dengan '.$dta['nama_agenda'].' Semester '.$dta['semester'].'</p>';
                                    }
                                  }
                                  echo '</td>
                                  ...
                                  if (in_array($access['l_ac']['edt'], $access['access'])) {
                                    if ($l->kode_agenda != NULL) {
                                      ...
                                      if ($dta != "") {
                                        ...
                                        $this->db->update('dp_anggaran',$dt1);
                                      }
                                    }  
                                  }
                                  ...
                                  <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body text-center">';
                                        if ($l->edit == 0) {
                                          echo '<p>Apakah anda yakin akan membuka kunci data dengan nama <b>'.$l->nama_anggaran.'</b> agar bisa diupdate?</p>';
                                        }else{
                                          echo '<p>Apakah anda yakin akan mengunci data dengan nama <b>'.$l->nama_anggaran.'</b> agar TIDAK bisa diupdate?</p>';
                                        }
                                        
                                      echo '</div>
                                      <div class="modal-footer">
                                      '.form_open('anggaran/lock_anggaran').'
                                        <input type="hidden" name="id" value="'.$l->id_anggaran.'">';
                                        if ($l->edit == 0) {
                                ...
                                if (in_array($access['l_ac']['del'], $access['access'])) {
                                  ...
                                  <div class="modal-dialog modal-sm modal-danger">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body text-center">
                                        <p>Apakah anda yakin akan menghapus data anggaran dengan nama <b>'.$l->nama_anggaran.'</b> dan seluruh data penilaian pada anggaran tersebut?</p>
                                      </div>
                                      <div class="modal-footer">
                                      '.form_open('anggaran/del_anggaran').'
                                        <input type="hidden" name="id" value="'.$l->id_anggaran.'">
