<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><i class="fas fa-clipboard-list"></i> Data Kode Akun</li>
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fas fa-clipboard-list"></i> Data Kode Akun</h3>
						<div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
							<button class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Tutup"><i class="fa fa-times"></i></button>
						</div>
					...
					<div class="box-body">
											...
											<div class="box-body">
												...
												<div class="col-md-6">
													<div class="row">
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" name="no_bukti" id="no_bukti" class="form-control" placeholder="Nomor Bukti">
															</div>
															<!-- <div class="col-sm-1">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="has-feedback">
																	<span class="fa fa-calendar form-control-feedback"></span>
																	<input type="text" name="tanggal" class="form-control pull-right date-picker" placeholder="Tanggal Periode" readonly="readonly" required="required">
																</div>
															</div>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-xs-2">
																<label class="pull-right" style="vertical-align: middle;">
																	...
																	<span style="padding-bottom: 9px;vertical-align: middle;"><b> Minus</b></span>
												...
												<div class="col-md-6">
													<div class="row">
														...
														<div class="form-group">
															<label class="col-sm-3 control-label">Catatan<br>(Tanggal Transaksi)</label>
															<div class="col-sm-9">
																<textarea name="catatan" class="form-control" placeholder="Catatan / Keterangan (Tanggal Transaksi)"></textarea>
															</div>
														</div>
													</div>
												</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="callout callout-info"><label><i class="fa fa-info-circle"></i> Bantuan</label><br>List Default menampilkan data Hari ini sampai 30 Hari kebelakang</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form_edit">
					...
					<div class="form-group">
						<label>NIK</label>
						<input type="text" id="data_nik_edit" name="karyawan" value="" class="form-control" readonly="readonly">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="has-feedback">
							<span class="fa fa-calendar form-control-feedback"></span>
							<input type="text" name="tanggal" class="form-control date-picker" id="data_tanggal_edit" placeholder="Tanggal Transaksi" readonly="readonly" required="required">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="pull-right" style="vertical-align: middle;">
							<span id="kar_off" style="font-size: 20px;"><i class="far fa-square" aria-hidden="true"></i></span>
							<span id="kar_on" style="display: none; font-size: 20px;"><i class="far fa-check-square" aria-hidden="true"></i></span>
							<span style="padding-bottom: 9px;vertical-align: middle;"><b> Nilai Minus</b></span>
							<input type="hidden" name="minusx">
						</label>
					...
					<div class="form-group">
						<label>Catatan (Tanggal Transaksi)</label>
						<textarea name="catatan" class="form-control" id="data_catatan_edit" placeholder="catatan (Tanggal Transaksi)"></textarea>
					</div>
				</div>
				<div class="modal-footer">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		// 	});
		// });
		getSelect2("<?php echo base_url('presensi/data_presensi/nik_employee')?>",'data_karyawan_add');
		getSelect2("<?php echo base_url('presensi/data_presensi/employee')?>",'data_mengetahui_add,#data_menyetujui_add');
		...
		$('#kar_off').click(function(){
			$('#kar_off').hide();
			$('#kar_on').show();
			$('input[name="minusx"]').val('1');
		})
		$('#kar_on').click(function(){
			$('#kar_off').show();
			$('#kar_on').hide();
			$('input[name="minusx"]').val('0');
		})
	});
...
//========== KODE AKUN Kode Akun ===================
	...
	function edit_modal_akun() {
		...
		$('#data_nominal_edit').val(callback['e_nominal']);
