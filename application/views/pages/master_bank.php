        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-list"></i> Daftar Bank</h3>
                    ...
                    <div class="col-md-12">
                      <div class="pull-left">
                        <?php if (in_array($access['l_ac']['add'], $access['access'])) {
                          echo '<button class="btn btn-success" id="btn_tambah_bidang" type="button" data-toggle="collapse" data-target="#add" aria-expanded="false" aria-controls="import"><i class="fa fa-plus"></i> Tambah Bank</button>';
                        }?>
                      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group col-md-12">
              <label class="col-md-6 control-label">Kode Bank</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_edit">
          ...
          <div class="form-group">
            <label>Kode Bank</label>
            <input type="text" placeholder="Masukkan Kode Bank" id="data_kode_edit" name="kode" value="" class="form-control" required="required" readonly="readonly">
          </div>
          <div class="form-group">
            <label>Nama Bank</label>
            <input type="text" placeholder="Masukkan Nama Bank" id="data_name_edit" name="nama" value="" class="form-control" required="required">
          </div>
        </div>
        <div class="modal-footer">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#table_data').DataTable( {
      ajax: {
        url: "<?php echo base_url('master/master_bank/view_all/')?>",
        type: 'POST',
  ...
  function view_modal(id) {
    var data={id_bank:id};
    var callback=getAjaxData("<?php echo base_url('master/master_bank/view_one')?>",data);  
    $('#view').modal('show');
  ...
  function do_edit(){
    if($("#form_edit")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/edt_bank')?>",'edit','form_edit',null,null);
      $('#table_data').DataTable().ajax.reload();
    }else{
      notValidParamx();
    } 
  ...
  function do_add(){
    if($("#form_add")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/add_bank')?>",null,'form_add',"<?php echo base_url('master/master_bank/kode');?>",'data_kode_add');
