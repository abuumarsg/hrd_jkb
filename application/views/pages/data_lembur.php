															...
															<div class="row">
																<div class="col-md-12">
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<div class="has-feedback">
																					<span class="fa fa-calendar form-control-feedback"></span>
																					<input type="text" name="tanggal" class="form-control pull-right date-range-30" placeholder="Tanggal Lembur" readonly="readonly" id="tanggal_add">
																				</div>
																			</div>
																		</div>
																		<div class="form-group">
																	...
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			<label class="col-sm-3 control-label">Pilihan Lembur</label>
																			<div class="col-sm-9">
																				<?php
																				$pilihanLembur[null] = 'Pilih Data';
																				$selu = [null];
																				$exselu = array('class'=>'form-control select2','placeholder'=>'Pilihan Lembur','required'=>'required','id'=>'data_pilihan_lembur_add','style'=>'width:100%');
																				echo form_dropdown('pilihan_lembur',$pilihanLembur,$selu,$exselu);
																				?>
																			</div>
																		</div>
																		<div class="form-group">
															...
															<div class="row">
																<div class="col-md-10">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-9">
																			<select class="form-control select2" name="bagian" id="bagian_add" required="required" style="width: 100%;" onchange="get_selet_emp(this.value)"></select>
																		</div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-9">
																			<label class="pull-left" style="vertical-align: middle;">
																				...
																				<span style="padding-bottom: 9px;vertical-align: middle;"><b> Di Bebankan ke bagian lain</b></span>
																				<input type="hidden" name="pembebanan" id="all_pembebanan">
																			</label>
																		</div>
																	</div>
																	<div class="form-group" id="div_bagian_beban" style="display:none;">
																		<label class="col-sm-3 control-label">Pilih Bagian</label>
																		<div class="col-sm-9">
																			<select class="form-control select2" name="bagian_beban" id="bagian_beban" style="width: 100%;"></select>
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-sm-3 control-label"></label>
																		<div class="col-sm-9">
																			<span id="div_span_kuota"></span><br>
																		</div>
																	</div>
																</div>
															</div>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Pilihan Lembur</label>
							<div class="col-md-6" id="data_pilihan_lembur_view"></div>
						</div>
						<div class="form-group col-md-12">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group clearfix">
								...
								<input type="text" name="tanggal" id="data_tanggal_edit" class="form-control date-range-30" value="" placeholder="Tanggal Lembur" readonly="readonly" required="required">
							</div>
							<div class="form-group clearfix">
						...
						<input type="hidden" name="kode_bagian" id="kode_bagian_edit">
						<input type="hidden" name="lama_lembur_old" id="lama_lembur_old_edit">
						<input type="hidden" name="count_old" id="count_old_edit">
						<input type="hidden" name="pilihan_lemburt_old" id="pilihan_lembur_old_edit">
						<div class="col-md-6">
							<div class="form-group clearfix">
							...
							<div class="form-group clearfix">
								<label>Pilihan Lembur</label>
								<?php
									$pilihanLembur[null] = 'Pilih Data';
									$selp = [null];
									$exselp = array('class'=>'form-control select2','placeholder'=>'Pilihan Lembur','required'=>'required','id'=>'data_pilihan_lembur_edit','style'=>'width:100%');
									echo form_dropdown('pilihan_lembur',$pilihanLembur,$selp,$exselp);
								?>
							</div>
							<div class="form-group clearfix">
							...
							<div class="form-group clearfix">
								<label class="pull-left" style="vertical-align: middle;">
									<span id="head_off_edit" style="font-size: 20px;"><i class="far fa-square" aria-hidden="true"></i></span>
									<span id="head_on_edit" style="display: none; font-size: 20px;"><i class="far fa-check-square" aria-hidden="true"></i></span>
									<span style="padding-bottom: 9px;vertical-align: middle;"><b> Di Bebankan ke bagian lain</b></span>
									<input type="hidden" name="pembebanan" id="all_pembebanan_edit">
									<input type="hidden" name="pembebanan_old" id="pembebanan_edit_old">
								</label>
							</div>
							<br>
							<br>
							<div id="div_bagian_beban_edit" style="display:none;">
								<div class="form-group clearfix">
									<label class="pull-left">Pilih Bagian</label>
									<select class="form-control select2" name="bagian_beban" id="bagian_beban_edit" style="width: 100%;"></select>
								</div>
								<input type="hidden" name="bagian_beban_edit_old" id="bagian_beban_edit_old">
							</div>
							<span id="div_span_kuota_edit"></span><br>
						</div>
					</div>
					<hr>
					<div class="row">
										...
										<div class="col-md-12">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="has-feedback">
														<span class="fa fa-calendar form-control-feedback"></span>
														<input type="text" name="tanggal" id="tgl_val" class="form-control pull-right date-range" placeholder="Tanggal Lembur">
													</div>
												</div><br><br>
											</div>
											<div class="col-md-6">
	...
	<div id="pLembur" class="modal fade" role="dialog">
		<div class="modal-dialog modal-lg modal-default">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h2 class="modal-title text-center">Sesuaikan Potong Jam Istirahat Lembur</h2>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<!-- <div class="form-group col-md-12">
								<label class="col-md-6 control-label">No Lembur</label>
								<div class="col-md-6" id="data_no_lembur_viewx"></div>
							</div> -->
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Tanggal Mulai</label>
								<div class="col-md-6" id="data_tanggal_m_viewx"></div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Tanggal Selesai</label>
								<div class="col-md-6" id="data_tanggal_s_viewx"></div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Jenis Lembur</label>
								<div class="col-md-6" id="data_jenis_lembur_viewx"></div>
							</div>
							<!-- <div class="form-group col-md-12">
								<label class="col-md-6 control-label">Lama Lembur</label>
								<div class="col-md-6" id="data_lama_lembur_viewx"></div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Potong Jam Istirahat</label>
								<div class="col-md-6" id="data_potong_viewx"></div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Keterangan (Kegiatan)</label>
								<div class="col-md-6" id="data_keterangan_viewx"></div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Status</label>
								<div class="col-md-6" id="data_status_val_viewx"></div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Dibuat Tanggal</label>
								<div class="col-md-6" id="data_create_date_viewx"></div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Diupdate Tanggal</label>
								<div class="col-md-6" id="data_update_date_viewx"></div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Dibuat Oleh</label>
								<div class="col-md-6" id="data_create_by_viewx">
								</div>
							</div>
							<div class="form-group col-md-12">
								<label class="col-md-6 control-label">Diupdate Oleh</label>
								<div class="col-md-6" id="data_update_by_viewx">
								</div>
							</div> -->
						</div>
					</div>
					...
					<div class="row text-center">
						...
						<div class="col-md-6">
							<div class="panel panel-success">
								<div class="panel-heading bg-green"><h4>Sesuaikan Potongan Jam Istirahat</h4></div>
								<div class="panel-body">
...
<script type="text/javascript">
	...
	function transaksi(kode) {
		...
		$('#head_off').click(function(){
			$('#head_off').hide();
			$('#head_on').show();
			$('input[name="pembebanan"]').val('1');
			$('#div_bagian_beban').show();
			getSelect2("<?php echo base_url('master/master_bagian/get_select2_all')?>",'bagian_beban');
			unsetoption('bagian_beban',['BAG001','BAG002']);
			pembebananBagian('1');
		});
		$('#head_on').click(function(){
			$('#head_off').show();
			$('#head_on').hide();
			$('input[name="pembebanan"]').val('0');
			$('#div_bagian_beban').hide();
			getSelect2("<?php echo base_url('master/master_bagian/get_select2_all')?>",'bagian_beban');
			unsetoption('bagian_beban',['BAG001','BAG002']);
			pembebananBagian('0');
	...
	function pembebananBagian(beban) {
		if(beban == '1'){
			$('#tanggal_add, #bagian_beban, #karyawan_add').change(function(){
				var tanggal = $('#tanggal_add').val();
				var bagian = $('#bagian_beban').val();
				var karyawan = $('#karyawan_add').val();
				var datax = {tanggal:tanggal, bagian:bagian, karyawan:karyawan};
				var tgl_ini=getAjaxData("<?php echo base_url('kuotalemburjkb/cekKuota')?>",datax);
				if (tgl_ini['bagian'] == null) {
					$('#div_span_kuota').html(tgl_ini['msg']).css('color','red');
					// $('#btn_save').prop('disabled', true);
				}else{
					$('#div_span_kuota').html(tgl_ini['msg']).css('color','green');
					// $('#btn_save').prop('disabled', false); 
				};
			});
		}else{
			$('#tanggal_add, #bagian_add, #karyawan_add').change(function(){
				var tanggal = $('#tanggal_add').val();
	...
	function view_modal(id) {
		...
		$('#data_pilihan_lembur_view').html(callback['pilihan_lembur']);
	...
	function edit_modal() {
		...
		$('#data_pilihan_lembur_edit').val(callback['e_pilihan_lembur']).trigger('change');
		...
		$('#kode_bagian_edit').val(callback['kode_bagian']);
		$('#lama_lembur_old_edit').val(callback['lama_lembur_kuota']);
		$('#count_old_edit').val(callback['count_old']);
		$('#pilihan_lembur_old_edit').val(callback['e_pilihan_lembur']);
		getSelect2("<?php echo base_url('master/master_bagian/get_select2_all')?>",'bagian_beban_edit');
		unsetoption('bagian_beban_edit',['BAG001','BAG002']);
		$('#bagian_beban_edit').val(callback['kode_bagian_kuota']);
		$('#bagian_beban_edit_old').val(callback['kode_bagian_kuota']);
		$('#all_pembebanan_edit').val(callback['pembebanan']);
		$('#pembebanan_edit_old').val(callback['pembebanan']);
		var bbnew = $('#bagian_beban_edit').val();
		var no_lembur = callback['no_lembur'];
		pembebananBagianEdit(callback['pembebanan'], callback['lama_lembur_kuota'], callback['count_old'], callback['pembebanan'], callback['kode_bagian_kuota'], bbnew, no_lembur);
		$('#head_off_edit').click(function(){
			$('#head_off_edit').hide();
			$('#head_on_edit').show();
			$('#all_pembebanan_edit').val('1');
			$('#div_bagian_beban_edit').show();
			// getSelect2("<?php //echo base_url('master/master_bagian/get_select2_all')?>",'bagian_beban_edit');
			// unsetoption('bagian_beban_edit',['BAG001','BAG002']);
			pembebananBagianEdit('1', callback['lama_lembur_kuota'], callback['count_old'], callback['pembebanan'], callback['kode_bagian_kuota'], bbnew, no_lembur);
		});
		$('#head_on_edit').click(function(){
			$('#head_off_edit').show();
			$('#head_on_edit').hide();
			$('#all_pembebanan_edit').val('0');
			$('#div_bagian_beban_edit').hide();
			// getSelect2("<?php //echo base_url('master/master_bagian/get_select2_all')?>",'bagian_beban_edit');
			// unsetoption('bagian_beban_edit',['BAG001','BAG002']);
			pembebananBagianEdit('0', callback['lama_lembur_kuota'], callback['count_old'], callback['pembebanan'], callback['kode_bagian_kuota'], bbnew, no_lembur);
			// $('#karyawan_add').val([]).trigger('change');
		});
	}
	function pembebananBagianEdit(beban, lama_lembur_kuota='', count_old='', beban_old='', bagian_beban='', bagian_beban_new='', no_lembur='') {
		var bagianx = $('#kode_bagian_edit').val();
		if(beban == '1'){
			$('#head_off_edit').hide();
			$('#head_on_edit').show();
			$('#all_pembebanan_edit').val('1');
			$('#div_bagian_beban_edit').show();
			var tanggal = $('#data_tanggal_edit').val();
			// var bagianx = $('#bagian_beban_edit').val();
			var karyawan = $('#karyawan_edit_trans').val();
			cekKuotaEdit(tanggal, bagianx, karyawan, lama_lembur_kuota, count_old, beban, beban_old, bagian_beban, bagian_beban_new, no_lembur);
		}else{
			$('#head_off_edit').show();
			$('#head_on_edit').hide();
			$('#all_pembebanan_edit').val('0');
			$('#div_bagian_beban_edit').hide();
			// var bagianx = bagian_all;
			var tanggal = $('#data_tanggal_edit').val();
			// var bagianx = $('#kode_bagian_edit').val();
			var karyawan = $('#karyawan_edit_trans').val();
			// alert(bagian);
		...
		$('#data_tanggal_edit, #karyawan_edit_trans, #bagian_beban_edit').change(function(){
			var valbeban = $('#all_pembebanan_edit').val();
			// if(valbeban == '1'){
				var bbnew = $('#bagian_beban_edit').val();
			// }else{
				var bagianx = $('#kode_bagian_edit').val();
			...
			var tanggal = $('#data_tanggal_edit').val();
			var karyawan = $('#karyawan_edit_trans').val();
			var datax = {tanggal:tanggal, bagian:bagianx, karyawan:karyawan, kuota_old:lama_lembur_kuota, count_old:count_old, beban:beban, beban_old:beban_old, bagian_beban:bagian_beban, bagian_beban_new:bbnew, no_lembur:no_lembur};
			var tgl_ini=getAjaxData("<?php echo base_url('kuotalemburjkb/cekKuotaEdit')?>",datax);
			if (tgl_ini['bagian'] == null) {
				$('#div_span_kuota_edit').html(tgl_ini['msg']).css('color','red');
			}else{
				$('#div_span_kuota_edit').html(tgl_ini['msg']).css('color','green');
			};
		});
	}
	function cekKuotaEdit(tanggal, bagianx, karyawan, lama_lembur_kuota, count_old, beban, beban_old, bagian_beban, bagian_beban_new, no_lembur){
		var datax = {tanggal:tanggal, bagian:bagianx, karyawan:karyawan, kuota_old:lama_lembur_kuota, count_old:count_old, beban:beban, beban_old:beban_old, bagian_beban:bagian_beban, bagian_beban_new:bagian_beban_new, no_lembur:no_lembur};
		var tgl_ini=getAjaxData("<?php echo base_url('kuotalemburjkb/cekKuotaEdit')?>",datax);
		if (tgl_ini['bagian'] == null) {
			$('#div_span_kuota_edit').html(tgl_ini['msg']).css('color','red');
		}else{
	...
	function potongLembur(id) {
		...
		$('#data_no_lembur_viewx').html(callback['no_lembur']);
		$('#data_tanggal_m_viewx').html(callback['tanggal_mulai']);
		$('#data_tanggal_s_viewx').html(callback['tanggal_selesai']);
		$('#data_lama_lembur_viewx').html(callback['lama_lembur']);
		$('#data_jenis_lembur_viewx').html(callback['jenis_lembur']);
		$('#data_potong_viewx').html(callback['potong']);
		$('#data_kode_customer_viewx').html(callback['kode_customer']);
		$('#data_keterangan_viewx').html(callback['keterangan']);
		$('#data_tabel_viewx').html(callback['table_lembur_kary']);
		$('#data_status_val_viewx').html(callback['status_val']);
		$('#data_create_date_viewx').html(callback['create_date']+' WIB');
		$('#data_update_date_viewx').html(callback['update_date']+' WIB');
		$('input[name="data_id_viewx"]').val(callback['no_lembur']);
		$('#data_create_by_viewx').html(callback['nama_buat']);
		$('#data_update_by_viewx').html(callback['nama_update']);
	}
