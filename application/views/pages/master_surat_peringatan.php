  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Master Surat Peringatan</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-briefcase"></i> Daftar Surat Peringatan</h3>
                    ...
                    <div class="col-md-12">
                      <div class="pull-left">
                        <?php if (in_array($access['l_ac']['add'], $access['access'])) {
                          echo '<button class="btn btn-success" id="btn_tambah" type="button" data-toggle="collapse" data-target="#add" aria-expanded="false" aria-controls="import"><i class="fa fa-plus"></i> Tambah Surat Peringatan</button>';
                        }?>
                      </div>
                    ...
                    <div class="collapse" id="add">
                      ...
                      <form id="form_add">
                        <div class="form-group">
                          <label>Kode Surat Peringatan</label>
                          <input type="text" readonly="readonly" placeholder="Masukkan Kode Surat Peringatan" name="kode" id="data_kode_add" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                          <label>Nama Surat Peringatan</label>
                          <input type="text" placeholder="Masukkan Nama Surat Peringatan" name="nama" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                          <label>Masa Habis Surat Peringatan</label>
                          <input type="number" placeholder="Masukkan Habis Surat Peringatan" name="masa" class="form-control" required="required">
                          <div class="row">
                            <div class="col-md-12">
                              <div class="col-xs-3">
                ...
                <div class="col-md-12">
                  <table id="table_data" class="table table-bordered table-striped table-responsive" width="100%">
                    <thead>
                      <tr>
                        <th>No.</th>
                        <th>Kode Surat Peringatan</th>
                        <th>Nama Surat Peringatan</th>
                        <th>Masa Habis Surat Peringatan</th>
                        <th>Nama Dokumen</th>
                        <th>Tanggal</th>
                        <th>Status</th>
                        <th>Aksi</th>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group col-md-12">
              <label class="col-md-6 control-label">Kode Surat Peringatan</label>
              <div class="col-md-6" id="data_kode_view"></div>
            </div>
            <div class="form-group col-md-12">
              <label class="col-md-6 control-label">Nama Surat Peringatan</label>
...
<script type="text/javascript">
  ...
  //wajib diisi
  var table="master_surat_peringatan";
  var column="id_sp";
  $(document).ready(function(){
    refreshCode();
    $('#table_data').DataTable( {
      ajax: {
        url: "<?php echo base_url('master/master_surat_peringatan/view_all/')?>",
        type: 'POST',
  ...
  function refreshCode() {
    kode_generator("<?php echo base_url('master/master_surat_peringatan/kode');?>",'data_kode_add');
  }
  function view_modal(id) {
    var data={id_sp:id};
    var callback=getAjaxData("<?php echo base_url('master/master_surat_peringatan/view_one')?>",data);  
    $('#view').modal('show');
    $('.header_data').html(callback['nama']);
    $('#data_kode_view').html(callback['kode_sp']);
  ...
  function edit_modal() {
    ...
    $('#data_kode_edit_old').val(callback['kode_sp']);
    $('#data_kode_edit').val(callback['kode_sp']);
  ...
  function do_edit(){
    if($("#form_edit")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/edt_surat_peringatan')?>",'edit','form_edit',null,null);
      $('#table_data').DataTable().ajax.reload();
    }else{
      notValidParamx();
    } 
  ...
  function do_add(){
    if($("#form_add")[0].checkValidity()) {
      submitAjax("<?php echo base_url('master/add_surat_peringatan')?>",null,'form_add',null,null);
