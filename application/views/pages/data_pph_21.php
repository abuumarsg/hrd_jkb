<style type="text/css">
	...
	<section class="content-header">
		<h1>
			...
			<small>Data PPH-21</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
			<li class="active">Data PPH-21</li>
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-list"></i> Daftar Data PPH-21</h3>
						<div class="box-tools pull-right">
					...
					<div class="box-body">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="pull-left">
													...
													// 	echo '<button type="button" class="btn btn-warning" onclick="model_export()" style="margin-left: 5px;float: left;"><i class="fas fa-file-excel-o"></i> Export</button>';
													// }
															...
															<div class="col-md-8">
																...
																<!-- <div class="col-md-4">
																	<div class="form-group">
																		<label>Pembetulan</label>
																		<?php
																			// $koreksi_copy2 = $this->otherfunctions->getNumberToAbjadList();
																			// $selsx2 = array('Pilih Data');
																			// $exsx2 = array('class'=>'form-control select2', 'id'=>'koreksix', 'style'=>'width:100%;','required'=>'required');
																			// echo form_dropdown('koreksi',$koreksi_copy2,$selsx2,$exsx2);
																		?>
																	</div>
																</div> -->
																<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<ul>
									<li>List Default menampilkan Data PPh 21 Pada Bulan <b><?=substr($days,3); ?></b>,</li>
								</div>
								<table id="table_data" class="table table-bordered table-striped table-responsive" width="100%">
									<thead>
										<tr>
											...
											?>
											<th rowspan="2">Jumlah Tunjangan (Rp)</th>
											<th rowspan="2">Uang Makan (Rp)</th>
											<th rowspan="2">Ritasi (Rp)</th>
											<th rowspan="2">Lembur (Rp)</th>
											<th rowspan="2">Perjalanan Dinas (Rp)</th>
											<th rowspan="2">UM, Insentif/ Tambahan Tugas Luar Kota, dll (Rp)</th>
											<th rowspan="2">Bonus / Komisi (Rp)</th>
											<th rowspan="2">THR (Rp)</th>
											<th class="text-center" style="background-color:green;" colspan="8">PENAMBAH</th>
											<th class="text-center" style="background-color:yellow;" colspan="9">POTONGAN</th>
											<th rowspan="2">YANG DITERIMA (Rp)</th>
											<th rowspan="2">Penghasilan Bruto Sebulan (Rp)</th>
											<th rowspan="2">Penghasilan Bruto Setahun (Rp)</th>
											<th rowspan="2">Pesangon (Rp)</th>
											<th rowspan="2">PPh Pesangon (Rp)</th>
											<th rowspan="2">Biaya Jabatan (Rp)</th>
											<th rowspan="2">Biaya Jabatan Setahun (Rp)</th>
											<th rowspan="2">Penghasilan Netto Sebulan (Rp)</th>
											<th rowspan="2">Penghasilan Netto Setahun (Rp)</th>
											<th rowspan="2">PTKP Sebulan (Rp)</th>
											<th rowspan="2">PTKP Setahun (Rp)</th>
											<th rowspan="2">PKP Sebulan (Rp)</th>
											<th rowspan="2">PKP Setahun (Rp)</th>
											<th rowspan="2">PPH 21 Sebulan (Rp)</th>
											<th rowspan="2">PPH 21 Setahun (Rp)</th>
											<th rowspan="2">Pajak Setahun (Rp)</th>
											<th rowspan="2">PPH 21 YANG DIBAYAR (Rp)</th>
											<th rowspan="2">PPH 21 YANG DIPOTONG (Rp)</th>
											<th rowspan="2">Tunjangan PPh (Rp)</th>
										...
										<tr>
											...
											<th>PPh	(Rp)</th>
											<th>JHT	(Rp)</th>
											<th>Kesehatan (BPJS) (Rp)</th>
											<th>Jaminan Pensiun (Rp)</th>
											<th>Premi Asuransi (Rp)</th>
											<th>Lainnya (Rp)</th>
											<th>JHT (Rp)</th>
											<th>JKK (Rp)</th>
											<th>JKM (Rp)</th>
											<th>Kesehatan (BPJS) (Rp)</th>
											<th>Iuran Pensiun (Rp)</th>
											<th>Piutang Karyawan (Rp)</th>
											<th>Koreksi Absen (Rp)</th>
											<th>Denda (Rp)</th>
											<th>Lainnya (Rp)</th>
										</tr>
									</thead>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Jumlah Tunjangan</label>
							<div class="col-md-6" id="data_tunjangan_view"></div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Uang Makan</label>
							<div class="col-md-6" id="data_uang_makan_view"></div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Ritasi</label>
							<div class="col-md-6" id="data_ritasi_view"></div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Lembur</label>
							<div class="col-md-6" id="data_lembur_view"></div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-6 control-label">Perjalanan Dinas</label>
							<div class="col-md-6" id="data_perdin_view"></div>
						</div>
						<div class="form-group col-md-12">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#pen_bulanx, #pen_tahunx').change(function(){
			...
			var kr = $('#koreksix').val();
			var data = {bulan:bl,tahun:th,koreksi:kr};
			var callback = getAjaxData("<?php echo base_url('cpayroll/data_pph_21/karyawan/')?>", data);
   ...
   function change_option(kode) {
	...
	function table_data(bulan, tahun) {
		...
		setTimeout(function () {
			$('#table_data').DataTable( {
				ajax: {
					url: "<?php echo base_url('cpayroll/data_pph_21/view_all/')?>",
					type: 'POST',
	...
	function view_modal(id) {
		...
		var callback=getAjaxData("<?php echo base_url('cpayroll/data_pph_21/view_one')?>",data);  
		$('#view').modal('show');
		$('.header_data').html(callback['nama_karyawan']+' - '+callback['nama_periode']+' ( '+callback['nama_sistem_penggajian']+' )');
		...
		$('#data_bulan_prd_view').html(callback['bulan_prd']);
		$('#data_tahun_prd_view').html(callback['tahun_prd']);
	...
	function do_add() {
		...
		var cek_ready = getAjaxData("<?php echo base_url('cpayroll/cek_data_pph')?>", data);
		if (cek_ready['msg'] == 'true') {
			submitAjax("<?php echo base_url('cpayroll/ready_data_pph')?>", null, 'form_add', null, null);
	...
	function do_delete_ada_data() {
		submitAjax("<?php echo base_url('Cpayroll/del_ada_data_pph')?>", 'confirm_ada_data', 'form_ada_data', null, null);
	...
	function do_rekap(file) {
		...
		if(tipe == '1'){
			if(bulan == 'all_month'){
				if(file == 'excel'){
					$.redirect('<?php echo base_url()."rekap/rekap_data_pph_21_all/"; ?>', 
					{
						tipe: tipe,
						bulan: bulan,
						tahun: tahun,
				...
				if(file == 'excel'){
					$.redirect('<?php echo base_url()."rekap/rekap_data_pph_21/"; ?>', 
					{
						tipe: tipe,
						bulan: bulan,
						tahun: tahun,
			...
			if(file == 'excel'){
				$.redirect('<?php echo base_url()."rekap/rekap_data_pph_21_tahunan/"; ?>', 
				{
					tipe: tipe,
					bulan: bulan,
					tahun: tahun,
	...
	function deleterow() {
  	...
  	function do_add_penunjang(){
		if($("#form_penunjang")[0].checkValidity()) {
			submitAjax("<?php echo base_url('cpayroll/add_penunjang')?>",null,'form_penunjang',null,null);
