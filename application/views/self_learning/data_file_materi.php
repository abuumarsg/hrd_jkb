<div class="content-wrapper">
   <section class="content-header">
      <h1>
         <i class="fas fa-sliders-h"></i> Data File Materi Learning
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
         <li class="active">Data File Materi Learning</li>
      </ol>
   </section>
         ...
         <div class="col-md-12">
            <div class="box box-success">
               <div class="box-header with-border">
                  <h3 class="box-title"><i class="fas fa-sliders-h"></i> Data File Materi Learning <small id="name_materi_header"></small></h3>
                                 ...
                                 <div class="collapse" id="add">
                                    ...
                                    <div class="col-md-8">
                                       <form id="form_add">
                                          ...
                                          <p class="text-muted"><i>File harus bertipe *.mp4, *.pptx, *.pdf, *.jpg, *.jpeg, *.png, *.xlsx, *.docx</i></p>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                             <label>Nama </label>
                                             <input type="text" placeholder="File Materi Learning " name="nama" class="form-control field" required="required">
                                          </div>
                                          <div class="form-group">
                                             <label>Keterangan</label>
                                             <textarea name="keterangan" id="keterangan_add" class="form-control" required="required" cols="30" rows="10" placeholder="Keterangan"></textarea>
                                          </div>
                                          <div class="form-group">
...
<script type="text/javascript">
  var url_select="<?php echo base_url('global_control/select2_global');?>";
   ...
   function checkFile(idf,idt,btnx) {
      var fext = ['mp4', 'pptx', 'pdf', 'jpg', 'jpeg', 'png', 'xlsx', 'docx'];
