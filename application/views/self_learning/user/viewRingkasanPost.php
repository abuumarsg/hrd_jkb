	...
	<div class="container-fluid">
		<div class="row mb-3 mt-2">
			...
			<div class="col-12 col-sm-8 text-center text-sm-right">
					<small><i>Sesi post-test telah selesai dan anda dapat langsung ke langkah selanjutnya dengan klik tombol dibawah.</i></small>
					<br> <br>
					<a class="btn btn-lg pull-right btn-success" data-remote="true" rel="nofollow" data-method="post" href="javascript:void(0)" onclick="doLearnProject()">Lanjutkan</a>
			</div>
		</div>
	</div>
