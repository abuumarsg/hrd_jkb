...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<i class="fas fa-history"></i> Riwayat Pembelajaran
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('pages/dashboard');?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
			</li>
			<li class="active view_nama_full">Riwayat Pembelajaran <?php echo $profile['nama'];?></li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-warning">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fas fa-history"></i> Riwayat Pembelajaran dan Pengembangan yang telah diikuti</small></h3>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group col-md-12">
							<label class="col-md-4 control-label">Jenis Pembelajaran</label>
							<div class="col-md-8" id="data_jenis_view"></div>
						</div>
						<div class="form-group col-md-12">
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-8" id="data_keterangan_view"></div>
						</div><hr>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#table_data').DataTable( {
			ajax: {
				url: "<?php echo base_url('learning/getDataHistoryUser/view_all/')?>",
				type: 'POST',
				data:{ }
			},
			scrollX: true,
	...
	function view_modal_start(id) {
		var data={id:id};
		var callback=getAjaxData("<?php echo base_url('learning/getDataHistoryUser/view_one')?>",data);  
	...
	function view_modal_file(id) {
		var data = {id:id};
		var callback=getAjaxData("<?php echo base_url('learning/getDataHistoryUser/view_file_jawaban')?>",data);   
		$('#modal_hasil').modal('toggle');
